...
export const STORE_CONFIGS: StoreConfig[] = [
  ...
  // SHOPIFY_STORES y añadir aquí su entrada.
  {
    ...
    selectors: { card: "", link: "", title: "", image: "", price: "" },
    notes: "Desactivada: no entra en el top 50 de marcas más populares en España. El scraper sigue intacto; volver a activarla es cambiar este enabled a true. Shopify (/products.json). Con precio original y % de descuento reales.",
  },
  {
    id: "popa",
    name: "Popa",
  ...
  },
  {
    ...
    selectors: { card: "", link: "", title: "", image: "", price: "" },
    notes: "Desactivada: no entra en el top 50 de marcas más populares en España. El scraper sigue intacto; volver a activarla es cambiar este enabled a true. Shopify (/products.json). Con precio original y % de descuento reales. Ojo: algunos productos traen compare_at_price a 0, el scraper los descarta.",
  },
  {
    id: "scalpers",
    name: "Scalpers",
